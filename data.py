...
KEEPSAKES = [
    ...
    },
    {
        ...
        "pinyin": "huā yuè cháng juǎn", "gloss": "a long scroll of flowers and moonlight",
        "variant": "Rose Pink",
        ...
        "why": "one lift of the lid reveals all four mooncakes at once, which turns the handover into a moment.",
        "body": [
            "Scrolls once carried the things <strong>too precious to fold</strong>: paintings, letters, promises. The Treasure Scroll carries its own the same way, in a long keepsake box that <strong>flips open to reveal all four mooncakes at once</strong>.",
            "Adorned in a <strong>luminous rose pink</strong> with <strong>sage green accents</strong>, its name echoes the collection itself: 花月情长 says affection lasts long, and <strong>花月长卷 gives that affection a shape, a scroll's worth of flowers and moonlight in one long box</strong>.",
